<x-layout title="{{ $title }}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <h1 class="title display-two"><span class="theme-gradient">Social Media Management</span></h1>
    ...
    <div class="rainbow-counterup-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="thumbnail"><img class="radius w-100" src="{{ asset('template/assets/images/about/medsos.webp') }}" alt="Images"></div>
                </div>
            </div>
            <div class="row ptb--60">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                    <div class="count-box counter-style-4 text-center">
                        ...
                        <h5 class="counter-title">Konten</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">
                    <div class="count-box counter-style-4 text-center">
                        ...
                        <h5 class="counter-title">Video</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">
                    <div class="count-box counter-style-4 text-center">
                        <div>
                            <div class="count-number"><span class="counter">8</span></div>
                        </div>
                        <h5 class="counter-title">App</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                        <h4 class="subtitle ">
                            <span class="theme-gradient">Kelola Medsos</span>
                        </h4>
                        <h2 class="title w-600 mb--20">Platform Sosial Media.</h2>
                    </div>
                </div>
            </div>
            <div class="row row--15 service-wrapper">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                    <div class="service service__style--1 icon-circle-style text-center">
                        ...
                        <div class="content">
                            <h4 class="title w-600"><a href="#">Instagram</a></h4>
                            <p class="description b1 color-gray mb--0">Cocok untuk galeri bisnis anda, karena di huni user dengan beragam dan lintas generasi.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                    <div class="service service__style--1 icon-circle-style text-center">
                        ...
                        <div class="content">
                            <h4 class="title w-600"><a href="#">Tiktok</a></h4>
                            <p class="description b1 color-gray mb--0">Pancing atau giring calon customer anda dengan konten hiburan dan tren terkini media social.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">
                    <div class="service service__style--1 icon-circle-style text-center">
                        ...
                        <div class="content">
                            <h4 class="title w-600"><a href="#">Facebook</a></h4>
                            <p class="description b1 color-gray mb--0">Tempat beragam bisnis di perkenalkan atau biasa kita sebut POSTING dengan beragam minat.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row row--40 align-items-center">
                    ...
                    <div class="video-btn">
                        <div class="video-popup icon-center">
                            <div class="overlay-content">
                                <div class="thumbnail"><img class="radius-small" src="{{ asset('template/assets/images/about/medsos-vid.webp') }}" alt="Corporate Image"></div>
                ...
                <div class="col-lg-6 mt_md--40 mt_sm--40">
                    <div class="content">
                        <div class="inner">
                            <h3 class="title">Kami sangat merekomendasikan <br> Medsos sebagai<strong> senjata ampuh buat bisnis digital kamu!.</strong>
                            </h3>
                            <ul class="feature-list">
                                <li>
                                    ...
                                    <div class="title-wrapper">
                                        <h4 class="title">Bangun Komunitas</h4>
                                        <p class="text">Biar bisnismu punya komunitas yang loyal dan interaktif.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="title-wrapper">
                                        <h4 class="title">Promosi Gratis</h4>
                                        <p class="text">Platform terbaik buat promosi tanpa biaya besar, langsung ke target audiens kamu.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <h2 class="title w-600 mb--20">Berapa Harga Kelola Medsos.</h2>
                    </div>
                </div>
            </div>
            <div class="row mt--30">
                            ...
                            <div class="row row--0">
                                <div class="col-lg-6">
                                    <div class="pricing-left">
                                        <h3 class="main-title">Paket Starting.</h3>
                                        <p class="description">Anda bisa mendapatkan desain medsos yang kece hanya dengan</p>
                                        <div class="price-wrapper">
                                            <span class="price-amount">Rp. 299k<sup>/Bln</sup></span>
                                        </div>
                                        ...
                                        <div class="pricing-offer">
                                            <div class="single-list">
                                                ...
                                                <ul class="plan-offer-list">
                                                    <li>
                                                        <i class="feather-check"></i> 15 Desain Feed
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Posting Sekali Sehari
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Ide Konten
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Kalender konten
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Optimasi Mingguan
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Setup Dashboard
                                                    </li>
                                                    <li>
                                                        <i class="feather-check"></i> Laporan Bulanan
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
